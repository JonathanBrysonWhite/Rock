...
namespace RockWeb.Blocks.Utility
{
    ...
    public partial class BW_StarkDetail : Rock.Web.UI.RockBlock
    {
        ...
        {
            public const string StarkId = "BW-StarkId";
        }
        ...
        private void ShowGroup()
        {
            ...
            if(group != null)
            {
                ltName.Text = $"<strong>Name:</strong> {group.Name}";
